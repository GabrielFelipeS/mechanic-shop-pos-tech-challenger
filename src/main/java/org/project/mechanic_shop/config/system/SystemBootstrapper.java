...
public class SystemBootstrapper {
    ...
    @Value("${app.seed.warehouse.name}") private String whName;
    @Value("${app.seed.warehouse.email}") private String whEmail;
    @Value("${app.seed.warehouse.document}") private String whDoc;
    @Value("${app.seed.warehouse.role}") private String whRole;

    @Value("${app.seed.receptionist.name}") private String rcName;
    @Value("${app.seed.receptionist.email}") private String rcEmail;
    @Value("${app.seed.receptionist.document}") private String rcDoc;
    @Value("${app.seed.receptionist.role}") private String rcRole;

    @Value("${app.seed.mechanic.name}") private String mcName;
    @Value("${app.seed.mechanic.email}") private String mcEmail;
    @Value("${app.seed.mechanic.document}") private String mcDoc;
    @Value("${app.seed.mechanic.role}") private String mcRole;

    @Value("${app.seed.salesperson.name}") private String slName;
    @Value("${app.seed.salesperson.email}") private String slEmail;
    @Value("${app.seed.salesperson.document}") private String slDoc;
    @Value("${app.seed.salesperson.role}") private String slRole;

    @Value("${app.seed.admin.name}") private String adName;
    @Value("${app.seed.admin.email}") private String adEmail;
    ...
    private void createDefaultUser(String role, String email, String document, String name) {
        ...
        log.info("Created DEFAULT USER '{}' with Role '{}' on APPLICATION (ID: {})",
