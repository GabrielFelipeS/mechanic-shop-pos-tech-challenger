...
import org.project.mechanic_shop.validators.VehicleValidator;
...
public class VehicleServiceImpl implements VehicleService {
    ...
    public Vehicle create(Vehicle obj, UUID ownerId) {
        ...
        var owner = userRepository.findByExternalId(ownerId)
    ...
    public Page<Vehicle> search(String licensePlate, String brand, String model, UUID ownerId, Pageable pageable) {
        log.info("Searching vehicles with filters - plate: {}, brand: {}, model: {}, ownerId: {}",
                licensePlate, brand, model, ownerId);
