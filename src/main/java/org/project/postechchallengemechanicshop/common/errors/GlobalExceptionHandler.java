...
import org.project.postechchallengemechanicshop.common.responses.ErrorResponse;
import org.project.postechchallengemechanicshop.exception.ApiException;
import org.project.postechchallengemechanicshop.exception.DuplicatedRegisterException;
import org.project.postechchallengemechanicshop.exception.OperationNotPermitted;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return new ErrorResponse(
                HttpStatus.UNPROCESSABLE_ENTITY.value(), "Validation error.", listErrors);
    }
    ...
    public ErrorResponse handleHttpMessageNotReadable(HttpMessageNotReadableException ex) {
        ...
        System.out.println("JSON error detected: " + ex.getCause());
