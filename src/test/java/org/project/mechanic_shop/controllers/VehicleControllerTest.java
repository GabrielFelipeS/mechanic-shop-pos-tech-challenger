...
class VehicleControllerTest {
    ...
    class FindById {
        ...
        void shouldFindVehicleByExternalId() throws Exception {
            ...
            mockMvc.perform(get("/api/vehicles/{id}", externalId))
    ...
    class Create {
        ...
        void shouldReturnConflictWhenCreateFails() throws Exception {
            ...
            when(service.create(any(Vehicle.class), eq(dto.ownerId())))
    ...
    class Update {
        ...
        void shouldUpdateVehicle() throws Exception {
            ...
            mockMvc.perform(put("/api/vehicles/{id}", externalId)
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(dto)))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.status").value(HttpStatus.OK.value()))
        ...
        void shouldReturnConflictWhenUpdateFails() throws Exception {
            ...
            when(service.update(eq(externalId), any(Vehicle.class), eq(dto.ownerId())))
                    .thenThrow(new IllegalArgumentException("duplicate"));
    ...
    class Search {
        ...
        void shouldSearchWithDefaultPageable() throws Exception {
            ...
            when(service.search(eq(vehicle.getLicensePlate()), any(), any(), any(), any(Pageable.class)))
                    .thenReturn(page);
